...
```python
__all__ = ['MediaSession', 'ThumbnailManager', 'ModelRegistry', 'SAM3Wrapper'...
```
...
### `📄 core/managers/media_session.py`
...
class FilterDefinition:
    """Metadata defining a database filter condition that can be evaluated on frame ..."""
@runtime_checkable

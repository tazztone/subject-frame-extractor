...
class Config(BaseSettings):
    ...
    yolo26l_url: str = "https://huggingface.co/onnx-community/yolo26l-ONNX/resolve/main/onnx/model_fp16.onnx"
    yolo26x_url: str = "https://huggingface.co/onnx-community/yolo26x-ONNX/resolve/main/onnx/model_fp16.onnx"
    yolo12l_seg_url: str = (
        "https://huggingface.co/h43lb1t0/yolo12l-person-seg/resolve/main/onnx/yolo12l-person-seg-extended.onnx"
    )
    ...
    default_person_detector_model: str = "YOLO26n"
    default_person_detector_class: str = "person"
    default_person_detector_threshold: float = 0.45

...
class FilteringHandler:
    ...
    def on_preset_changed(self, preset_name: str) -> dict:
        ...
        presets = {
            "No Filters": {},
            "Quality Focus": {
                "sharpness_min": 20, "contrast_min": 20, "edge_strength_min": 15
            },
            "Face Priority": {
                "face_sim_min": 0.6, "eyes_open_min": 0.5
            },
            "Balanced": {
                "sharpness_min": 15, "contrast_min": 15, "face_sim_min": 0.4
            },
        }
    ...
    def on_auto_set_thresholds(
        ...
        *checkbox_values: bool
        ...
        selected_metrics = [
            name for name, enabled in zip(metric_names, checkbox_values) if enabled
        ]
        
        return auto_set_thresholds(
            per_metric_values or {},
            percentile,
            slider_keys,
            selected_metrics
        )

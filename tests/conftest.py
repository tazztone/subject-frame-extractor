...
class VideoOpenFailure(RuntimeError): pass
class TransparentContext:
    def __enter__(self, *args, **kwargs): return self
    def __exit__(self, *args, **kwargs): pass
    def __call__(self, func=None): return func if func is not None else self
...
_cuda_mod = _create_mock_module("torch.cuda", {
...
_torch_mod = _create_mock_module("torch", {
    "__path__": [],
    "cuda": _cuda_mod,
    ...
    "tensor": MagicMock(side_effect=lambda data, **kwargs: _create_mock_tensor("tensor", getattr(data, "shape", None), data)),
    "float32": MagicMock(),
    "device": MagicMock(),
...
modules_to_mock = {
    ...
    "torchvision.transforms.v2": _create_mock_module("torchvision.transforms.v2", {
        ...
        "functional": _create_mock_module("torchvision.transforms.v2.functional", {
    ...
    "scenedetect": _create_mock_module("scenedetect", {
        "__path__": [],
    ...
    "sam3.model_builder": _create_mock_module("sam3.model_builder", {

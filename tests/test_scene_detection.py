...
class TestSceneDetection:
    ...
    @patch('cv2.resize')
    @patch('cv2.cvtColor')
    def test_make_photo_thumbs(self, mock_cvtcolor, mock_resize, mock_imread, 
                                mock_logger, mock_config_simple, tmp_path):
    ...
    @patch('cv2.imread')
    def test_make_photo_thumbs_unreadable_image(self, mock_imread, mock_logger, 
                                                 mock_config_simple, tmp_path):
